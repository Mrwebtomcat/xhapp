...
<template>
	<div class="moneymdoul">
		<navigBar :ShowUsericon="true" @wholookme="wholookme" :showBtn="true"  @melookwho="melookwho"  :titleBg="0" :showRighticon="true" :showBtnarrytxt="['谁看过我','我看过谁']" :requreClass="`icon-fanhui`" :rightClass="`icon-shezhi`" :titleText="'浏览记录'" @checkMe="clickMe" @iconRight="false"></navigBar>
		<!--滚动区间-->
